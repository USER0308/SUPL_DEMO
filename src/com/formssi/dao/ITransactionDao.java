...
public interface ITransactionDao {
	...
	public void updateTransactionStatusByConID(@Param(value="conID")String conId,@Param(value="status")String status,@Param(value="updateTime")String updateTime);  // 更新交易状态 --U,未发货--A,已发货
